...
opišemo s posameznimii. Poglejmo, katere razrede je smiselno implementirati ter
...
tip (npr. \textbf{bool} v C++), kjer bi vrednost \textbf{true} predstavljala
dosegljivost, \textbf{false} pa zasedenost.
...
\section{Avtomatizirana izdelava urnika} % razdelek
